...
class UnifiedKeybindingsPanel(QDialog):
    ...
    def _build_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Action", "Default", "Current", "Status"])
    ...
    def _populate_table(self):
        ...
        for row, action in enumerate(actions):
            ...
            if "✓" in status:
                status_item.setStyleSheet("color: #10b981;")
            elif "!" in status:
                status_item.setStyleSheet("color: #f97316;")
            elif "✗" in status:
                status_item.setStyleSheet("color: #ef4444;")
    ...
    def _on_item_changed(self, item):
        ...
        success, message = KEYBINDINGS.set_binding(
            action_name, new_shortcut, check_conflicts=True
        )
